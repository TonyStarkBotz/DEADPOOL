...
__repo__ = "https://github.com/TonyStarkBotz/DEADPOOL"
__version__ = "DEADPOOL ᴠ4.5.0"
__license__ = "GNU GENERAL PUBLIC LICENSE V2"
__copyright__ = "Copyright (C) 2024-present TonyStark <https://github.com/TonyStarkBotz>"
